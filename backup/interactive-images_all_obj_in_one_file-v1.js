(function webpackUniversalModuleDefinition(root, factory) {
    ...
    return  (function() {
        ...
        function ViewPublisher() {
            ...
            //propositionRender(proposition) -> getTemplate(MAP(type, template)) -> templateEngine(template, value) -> html -> innerHTML
            ...
            var rebuildComponent = function () {
                ...
                if (propositionValue) {
                    ...
                    alert('Select state, please'); //todo: do not use alert
                }
