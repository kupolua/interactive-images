...
function HTMLTemplatesLibrary(templateType) {
    ...
    function fixedChoiceTemplate(templateValues) {
        ...
        htmlComponentTemplate = ' \
                ...
                <div id=\"image-container\"> \
                    <img id=\"image-state\" src=\"data:image/gif;base64,' + templateValues.imageBase64 + '\" alt=\"' + templateValues.imageName + '\" style=\"max-width:100%;\"> \
                </div> \
